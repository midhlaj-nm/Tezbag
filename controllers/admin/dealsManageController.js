...
const saveDeals = async (req, res) => {
  try {
    ...
    const {
      offerName, couponName, selectedType, discountPercentage, discountValue, startDate, endDate, selectedItems, minPurchase, maxPurchase,
    } = req.body;
...
module.exports = {
  loadDeals, saveDeals, editDeals, deleteDeal,
};
